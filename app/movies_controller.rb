...
#WHERE returns the activerecord thing, find_by returns the object

def can_find_using_where_clause_and_be_sorted(release_date: 2000)
  # For this test return all movies released after 2002 and ordered by 
  # release date descending
  Movie.where(release_date > 2002).reverse_order.limit(2)
end
